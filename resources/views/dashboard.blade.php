                            ...
                            <div class="widget-first">
                                ...
                                <div class="d-flex align-items-center mt-3 justify-content-between">
                                    ...
                                    <p class="text-muted mb-0 fs-13 d-flex flex-column">
                                        <span class="text-success px-2 py-1 bg-success-subtle rounded-4 me-2">+9.5%</span>
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="widget-first">
                                ...
                                <div class="d-flex align-items-center mt-3 justify-content-between">
                                    ...
                                    <p class="text-muted mb-0 fs-13 d-flex flex-column">
                                        <span class="text-success px-2 py-1 bg-success-subtle rounded-4 me-2">+6.5%</span>
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="widget-first">
                                ...
                                <div class="d-flex align-items-center mt-3 justify-content-between">
                                    <p class="mb-0 text-dark mt-1">Project this month</p>
                                    <p class="text-muted mb-0 fs-13 d-flex flex-column">
                                        <span class="text-danger px-2 py-1 bg-danger-subtle rounded-4 me-2">-7.5%</span>
                                    </p>
                                </div>
                            ...
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Design new
                        ...
                        <li>
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Update website
                                                UI</h6>
                        ...
                        <li>
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Up with vendor
                                                invoices</h6>
                        ...
                        <li>
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Sales Accounting
                                            </h6>
                        ...
                        <li>
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Update User
                                                Database</h6>
                        ...
                        <li>
                            <div class="d-flex mb-0 pb-0">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Monthly sales
                                                report</h6>
                                    ...
                                    <div class="align-content-center text-center rounded-3">
                                        <span
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                                viewBox="0 0 24 24">
                                                <path fill="#060707" fill-rule="evenodd"
                                    ...
                                    <div class="align-content-center text-center rounded-3">
                                        <span
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                                viewBox="0 0 24 24">
                                                <path fill="#060707" fill-rule="evenodd"
                                                    d="M5.172 3.172C4 4.343 4 6.229 4 10v4c0 3.771 0 5.657 1.172 6.828S8.229 22 12 22s5.657 0 6.828-1.172S20 17.771 20 14v-4c0-3.771 0-5.657-1.172-6.828S15.771 2 12 2S6.343 2 5.172 3.172M9 4.25a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5zM12 19a2 2 0 1 0 0-4a2 2 0 0 0 0 4"
                                                    clip-rule="evenodd" />
                                            </svg>
                                        </span>
                                    </div>
                                ...
                                <div class="flex-shrink-0">
                                    ...
                                    <div class="align-content-center text-center rounded-3">
                                        <span
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                                viewBox="0 0 24 24">
                                                <g fill="#060707" fill-rule="evenodd" clip-rule="evenodd">
                                                    <path
                    ...
                    <div class="table-responsive">
                        <table class="table table-traffic mb-0">
                                    ...
                                    <div class="avatar-group avatar-list-stack">
                                        <a href="#">
                                            <img class="avatar-img avatar avatar-xs rounded-circle img-fluid"
                                                src="assets/images/users/user-12.jpg" alt="Dianna Smiley">
                                        </a>
                                        <a href="#">
                                            <img class="avatar-img avatar avatar-xs rounded-circle img-fluid"
                                        ...
                                        <a href="#">
                                            <img class="avatar-img avatar avatar-xs rounded-circle img-fluid"
                                                src="assets/images/users/user-4.jpg" alt="Daniela Dewitt">
                                        </a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="progress progress-sm w-100 mt-0" role="progressbar" aria-valuenow="0"
