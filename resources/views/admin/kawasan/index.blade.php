                                                ...
                                                <div class="modal-body">
                                                    <div class="row g-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="type_unit_id[]"
                                                                class="form-control @error('type_unit_id') is-invalid @enderror">

                                                                <option value="">-- Pilih Type Unit --</option>

                                                                @foreach ($types as $type)
                                                                    <option value="{{ $type->id }}"
                                                                        {{ in_array($type->id, (array) old('type_unit_id', $item->typeUnits->pluck('id')->toArray() ?? [])) ? 'selected' : '' }}>
                                                                        {{ $type->nama_type }}
                                                                    </option>
                                                                @endforeach
                                ...
                                <div class="modal fade" id="deleteModal{{ $item->id }}" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Apakah anda yakin ingin menghapus kawasan <b>{{ $item->nama_kawasan }}</b>
                                                ?
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('kawasan.delete', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div>
                                                ...
                                                <select name="type_unit_id[]"
                                                    ...
                                                    @foreach ($types as $type)
                                                        <option value="{{ $type->id }}"
                                                            {{ in_array($type->id, (array) old('type_unit_id')) ? 'selected' : '' }}>
                                                            {{ $type->nama_type }}
                                                        </option>
                                                    @endforeach
